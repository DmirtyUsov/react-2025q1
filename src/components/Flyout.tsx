...
export const Flyout = () => {
  ...
  return (
    favorites.length > 0 && (
      <div className="sticky bottom-0 left-0 max-h-max max-w-max overflow-hidden rounded-2xl border-2 border-lime-600 bg-lime-50 text-center shadow-2xl dark:bg-gray-600">
        ...
        <div className="mt-4 w-full cursor-pointer rounded-lg bg-lime-600 px-4 py-2 text-white transition-colors hover:bg-lime-500">
          <a
            href={apiService.convertCharacters2Csv(favorites)}
